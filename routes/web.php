...
use App\Http\Controllers\Platform\HostingConnectionController as PlatformHostingConnectionController;
...
use App\Http\Controllers\Platform\SitePublicationController as PlatformSitePublicationController;
...
Route::middleware(['auth', '2fa.required', 'platform.admin'])
    ...
    ->group(function (): void {
        ...
        Route::get('/hosting', [PlatformHostingConnectionController::class, 'index'])->name('hosting.index');
        Route::get('/hosting/create', [PlatformHostingConnectionController::class, 'edit'])->defaults('id', 0)->name('hosting.create');
        Route::get('/hosting/{id}/edit', [PlatformHostingConnectionController::class, 'edit'])->whereNumber('id')->name('hosting.edit');
        Route::post('/hosting/{id}/store', [PlatformHostingConnectionController::class, 'store'])->whereNumber('id')->name('hosting.store');
        Route::post('/hosting/{connection}/test', [PlatformHostingConnectionController::class, 'test'])->middleware('throttle:10,1')->name('hosting.test');
        Route::post('/hosting/{connection}/environments/sync', [PlatformHostingConnectionController::class, 'syncEnvironments'])->middleware('throttle:10,1')->name('hosting.environments.sync');
        Route::get('/publications', [PlatformSitePublicationController::class, 'index'])->name('publications.index');
        Route::get('/publications/create', [PlatformSitePublicationController::class, 'edit'])->defaults('id', 0)->name('publications.create');
        Route::get('/publications/{id}/edit', [PlatformSitePublicationController::class, 'edit'])->whereNumber('id')->name('publications.edit');
        Route::post('/publications/{id}/store', [PlatformSitePublicationController::class, 'store'])->whereNumber('id')->name('publications.store');
        Route::post('/publications/{publication}/prepare-publish', [PlatformSitePublicationController::class, 'preparePublish'])->middleware('throttle:10,1')->name('publications.prepare-publish');
        Route::post('/publications/{publication}/provision-database', [PlatformSitePublicationController::class, 'provisionDatabase'])->middleware('throttle:5,1')->name('publications.provision-database');
        Route::post('/publications/{publication}/create-database', [PlatformSitePublicationController::class, 'createDatabase'])->middleware('throttle:2,1')->name('publications.create-database');
        Route::post('/publications/{publication}/apply-env-vars', [PlatformSitePublicationController::class, 'applyEnvVars'])->middleware('throttle:5,1')->name('publications.apply-env-vars');
        Route::post('/publications/{publication}/apply-domain', [PlatformSitePublicationController::class, 'applyDomain'])->middleware('throttle:5,1')->name('publications.apply-domain');
        Route::post('/publications/{publication}/start-deployment', [PlatformSitePublicationController::class, 'startDeployment'])->middleware('throttle:3,1')->name('publications.start-deployment');
        Route::post('/publications/{publication}/remote-setup', [PlatformSitePublicationController::class, 'runRemoteSetup'])->middleware('throttle:2,1')->name('publications.remote-setup');
