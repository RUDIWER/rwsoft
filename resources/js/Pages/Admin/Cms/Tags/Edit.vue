<template>
    ...
    <AdminLayout :title="pageTitle" :suppress-flash="true">
                    ...
                    >
                        <div class="flex min-w-0 items-start gap-3">
                            <div
                                ...
                                aria-hidden="true"
                            >
                                <span class="mdi mdi-tag text-2xl" />
                            </div>
                            <div class="min-w-0">
                                ...
                                <CardDescription class="mt-1">
                                    {{
                                        t(
                                            'tags.form.basic_description',
                                            'This tag automatically creates a public CMS page.',
                                        )
                                    }}
                                </CardDescription>
                            </div>
                ...
                <CardContent class="min-h-0 flex-1 overflow-y-auto p-0">
                    ...
                    <div class="space-y-5 p-4 sm:p-5">
                        <AiTranslationReviewBanner
                            ...
                            type="tag"
                            :record-id="tag.id"
                            :review="tag.ai_translation_review"
                        />
                        ...
                        <section v-if="activeTab === 'basis'" class="space-y-5">
                            <div class="space-y-4">
                                ...
                                >
                                    {{
                                        t(
                                            'tags.form.save_before_translations',
                                            'Save the tag first to manage translations.',
                                        )
                                    }}
                                </p>
                            </div>
                                    ...
                                    <div class="grid gap-4 md:grid-cols-2">
                                        ...
                                        <div v-else class="grid gap-2">
                                            ...
                                            <p class="text-xs text-slate-500">
                                                {{
                                                    t(
                                                        'tags.form.language_readonly_help',
                                                        'The language is fixed for existing tags. Use translations to create another language version.',
                                                    )
                                                }}
                                            </p>
                                        </div>
                                ...
                                >
                                    ...
                                    <div class="grid gap-2">
                                        ...
                                        <p class="text-xs text-slate-500">
                                            {{
                                                t(
                                                    'tags.form.active_help',
                                                    'Determines whether this tag can be used in CMS relations and overviews.',
                                                )
                                            }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="grid gap-2">
                                        ...
                                        <p class="text-xs text-slate-500">
                                            {{
                                                t(
                                                    'tags.form.page_status_help',
                                                    'Determines whether the linked tag page is publicly visible.',
                                                )
                                            }}
                                        </p>
                                    </div>
                        ...
                        >
                            <div class="grid gap-4 md:grid-cols-2">
                                <div class="grid gap-2">
                                    <Label for="archive_template_id">
                                        {{
                                            t(
                                                'templates.fields.tag_archive_template',
                                                'Archive template',
                                            )
                                        }}
                                    </Label>
                                    ...
                                    <p class="text-xs text-slate-500">
                                        {{
                                            t(
                                                'tags.form.archive_template_help',
                                                'Optional template for the tag archive page with blogs.',
                                            )
                                        }}
                                    </p>
                                </div>
                                ...
                                <div class="grid gap-2">
                                    <Label for="detail_template_id">
                                        {{
                                            t(
                                                'templates.fields.tag_detail_template',
                                                'Detail template',
                                            )
                                        }}
                                    </Label>
                                    ...
                                    <p class="text-xs text-slate-500">
                                        {{
                                            t(
                                                'tags.form.detail_template_help',
                                                'Optional template for the tag info/detail page.',
                                            )
                                        }}
                                    </p>
                                </div>
                            ...
                            <div class="grid gap-2">
                                <CmsBlockEditor
                                    ...
                                    upload-context-type="tag"
                                    :upload-context-id="tagRecordId"
                                    :label="
                                        t(
                            ...
                            >
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-slate-500">
                                        {{
                                            t(
                                                'tags.form.translations_description',
                                                'Create and open linked language versions of this tag.',
                                            )
                                        }}
                                    </p>
                                </div>
            ...
            <DialogContent class="sm:max-w-md">
                <DialogHeader>
                    <DialogTitle>
                        {{
                            t(
                                'tags.form.translation_dialog_title',
                    ...
                    <DialogDescription>
                        {{
                            t(
                                'tags.form.translation_dialog_description',
                                'Choose whether the draft tag is translated with AI or first created as a copy.',
                            )
                        }}
                    </DialogDescription>
                </DialogHeader>
                    ...
                    >
                        ...
                        <p>
                            {{
                                t(
                                    'tags.form.ai_help',
                                    'Translate with AI immediately creates a translated draft tag with linked draft page.',
                                )
                            }}
                        </p>
                        <p>
        ...
        <CmsRevisionHistoryDialog
            ...
            subject-type="tag"
            restore-route-name="admin.cms.tags.revisions.restore"
            :restore-route-params="{ tag: tag.id }"
            :revisions="revisions"
        />
    </AdminLayout>
</template>
...
const form = useForm({
    ...
    slug: props.tag?.slug ?? '',
    locale: props.tag?.locale ?? props.activeLanguages[0]?.locale ?? 'nl',
    description: props.tag?.description ?? '',
    archive_template_id: props.tag?.archive_template_id ?? '',
    detail_template_id: props.tag?.detail_template_id ?? '',
    is_active: Boolean(props.tag?.is_active ?? true),
    status: props.tag?.status ?? 'draft',
    template: props.tag?.template ?? '',
    excerpt: props.tag?.excerpt ?? props.tag?.description ?? '',
    content_blocks: props.tag?.content_blocks ?? defaultBlocks(),
    seo_title: props.tag?.seo_title ?? '',
    seo_description: props.tag?.seo_description ?? '',
    canonical_url: props.tag?.canonical_url ?? '',
    og_image_path: props.tag?.og_image_path ?? '',
    noindex: Boolean(props.tag?.noindex ?? false),
    is_searchable: Boolean(props.tag?.is_searchable ?? true),
    pdf_download_enabled: Boolean(props.tag?.pdf_download_enabled ?? false),
    published_at: props.tag?.published_at ?? '',
    structured_data_schema_type:
        props.tag?.structured_data_schema_type ?? 'auto',
    structured_data_extra: props.tag?.structured_data_extra ?? '',
});

const isEditMode = computed(() => Boolean(props.tag?.id));
const tagRecordId = computed(() => props.tag?.id ?? null);
const recordIdLabel = computed(() => props.tag?.id ?? '-');
...
const updatedAtLabel = computed(() => formatRecordDate(props.tag?.updated_at));
const createdAtLabel = computed(() => formatRecordDate(props.tag?.created_at));
const pageTitle = computed(() =>
    isEditMode.value
        ? t('tags.form.edit_title', 'Edit tag')
        : t('tags.form.create_title', 'Add tag'),
);
...
const baseValidationFields = {
    ...
    status: requiredTextField('tags.form.page_status', 'Page status', 'status'),
    ...
    archive_template_id: {
        label: t('templates.fields.tag_archive_template', 'Archive template'),
        tab: 'content',
    ...
    detail_template_id: {
        label: t('templates.fields.tag_detail_template', 'Detail template'),
        tab: 'content',
...
async function submit() {
    ...
    form.post(route('admin.cms.tags.store', { id: props.tag?.id ?? 0 }), {
        preserveScroll: true,
        onError: () => {
            nextTick(() => {
...
function createTranslation(useAi) {
    ...
    translationForm.post(
        route('admin.cms.tags.translations.store', { id: props.tag.id }),
        {
            onFinish: () => {
...
function handleTranslationChipClick(item) {
    ...
    if (!item.isCurrent && item.id) {
        window.location.href = route('admin.cms.tags.edit', { id: item.id });
    }
}
...
function translationChipTitle(item) {
    if (item.type === 'missing') {
        return t(
            'tags.form.missing_translation_help',
            'No linked tag for this active language yet.',
        );
    }
