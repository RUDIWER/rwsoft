...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('acl_permissions')->updateOrInsert(
            ['route_name' => 'admin.cms.settings.starter-export'],
        ...
        $permissionId = DB::table('acl_permissions')->where('route_name', 'admin.cms.settings.starter-export')->value('id');
    ...
    {
        $data = [
            'description' => '[CMS] Starter-site exporteren',
            'menu' => false,
            'created_at' => $now,
            'updated_at' => $now,
        ];
        ...
        if (Schema::hasColumn('acl_permissions', 'module_id')) {
            ...
            $data['action_id'] = $this->lookupId('acl_permission_actions', 'export', 'Exporteren');
