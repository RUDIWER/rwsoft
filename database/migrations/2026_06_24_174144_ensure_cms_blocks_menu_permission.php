...
return new class extends Migration
{
    ...
    private function oldRoleAssignments(): array
    {
        ...
        return DB::table('acl_permission_role')
    ...
    {
        if ($oldRoleAssignments === [] || ! Schema::hasTable('acl_permission_role')) {
            return;
        }

        $newPermissionIds = DB::table('acl_permissions')
    ...
    private function deactivateOldRoleAssignments(mixed $now): void
    {
        ...
        $oldPermissionIds = DB::table('acl_permissions')
