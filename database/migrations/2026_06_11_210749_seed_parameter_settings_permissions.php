...
return new class extends Migration
{
    ...
    {
        return [
            ['route_name' => 'admin.parameters.edit', 'description' => '[Instellingen] AI instellingen openen', 'action' => 'Bewerken', 'menu' => true],
            ['route_name' => 'admin.parameters.store', 'description' => '[Instellingen] AI instellingen bewaren', 'action' => 'Bewaren', 'menu' => false],
        ];
    }
};
