...
return new class extends Migration
{
    ...
    {
        return [
            ['route_name' => 'admin.cms.redirects.create', 'description' => '[CMS] Redirect toevoegen', 'action' => 'Toevoegen'],
            ['route_name' => 'admin.cms.redirects.edit', 'description' => '[CMS] Redirect bewerken', 'action' => 'Bewerken'],
        ];
    }
};
