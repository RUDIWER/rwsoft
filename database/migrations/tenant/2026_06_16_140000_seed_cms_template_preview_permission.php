...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('acl_permissions')->updateOrInsert(
            ['route_name' => 'admin.cms.templates.preview'],
        ...
        $permissionId = DB::table('acl_permissions')->where('route_name', 'admin.cms.templates.preview')->value('id');
    ...
    {
        $data = [
            'description' => '[CMS] Template preview bekijken',
            'menu' => false,
            'created_at' => $now,
            'updated_at' => $now,
        ];
        ...
        if (Schema::hasColumn('acl_permissions', 'module_id')) {
            ...
            $data['action_id'] = $this->lookupId('acl_permission_actions', 'preview', 'Preview bekijken');
