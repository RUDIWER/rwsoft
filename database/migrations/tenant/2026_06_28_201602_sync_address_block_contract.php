...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $blockName = __('cms_admin_ui.'.($definition['label_key'] ?? 'components.block_editor.address_block'));
        $sharedPayload = [
    ...
    {
        // Intentionally irreversible: address_block is a system block contract.
    }
