...
return new class extends Migration
{
    ...
    {
        return [
            ['route_name' => 'admin.cms.forms.create', 'description' => '[CMS] Formulier toevoegen', 'action' => 'Toevoegen'],
            ['route_name' => 'admin.cms.forms.edit', 'description' => '[CMS] Formulier bewerken', 'action' => 'Bewerken'],
        ];
    }
};
