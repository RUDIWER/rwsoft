...
return new class extends Migration
{
    ...
    {
        return [
            'admin.queries.groups.index' => 'Overzicht',
            'admin.queries.groups.create' => 'Bewerken',
            'admin.queries.groups.edit' => 'Bewerken',
            'admin.queries.groups.store-new' => 'Bewaren',
            'admin.queries.groups.store' => 'Bewaren',
            'admin.queries.groups.delete' => 'Verwijderen',
        ];
    }
};
