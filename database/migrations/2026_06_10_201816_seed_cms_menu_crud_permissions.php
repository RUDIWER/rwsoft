...
return new class extends Migration
{
    ...
    {
        return [
            ['route_name' => 'admin.cms.menus.create', 'description' => '[CMS] Menu toevoegen', 'action' => 'Toevoegen'],
            ['route_name' => 'admin.cms.menus.edit', 'description' => '[CMS] Menu bewerken', 'action' => 'Bewerken'],
            ['route_name' => 'admin.cms.menu-items.store', 'description' => '[CMS] Menu-item bewaren', 'action' => 'Bewaren'],
            ['route_name' => 'admin.cms.menu-items.destroy', 'description' => '[CMS] Menu-item verwijderen', 'action' => 'Verwijderen'],
        ];
    }
};
