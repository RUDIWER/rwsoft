...
return new class extends Migration
{
    ...
    {
        return [
            ['route_name' => 'admin.cms.block-placements.style-revisions.index', 'description' => '[CMS] Block stijlrevisies bekijken', 'action_key' => 'view', 'action_id' => 2, 'url' => 'admin/cms/block-placements/{placement}/style-revisions'],
            ['route_name' => 'admin.cms.block-placements.style-revisions.publish', 'description' => '[CMS] Block stijlrevisie publiceren', 'action_key' => 'publish', 'action_id' => 21, 'url' => 'admin/cms/block-placements/{placement}/style-revisions/publish'],
            ['route_name' => 'admin.cms.block-placements.style-revisions.republish', 'description' => '[CMS] Block stijlrevisie herpubliceren', 'action_key' => 'publish', 'action_id' => 21, 'url' => 'admin/cms/block-placements/{placement}/style-revisions/{revision}/republish'],
        ];
    }
};
