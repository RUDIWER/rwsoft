...
return new class extends Migration
{
    ...
    {
        return [
            'admin.queries.builder.index' => 'Overzicht',
            'admin.queries.builder.create' => 'Bewerken',
            'admin.queries.builder.edit' => 'Bewerken',
            'admin.queries.builder.store-new' => 'Bewaren',
            'admin.queries.builder.store' => 'Bewaren',
            'admin.queries.builder.inspect' => 'Inspecteren',
            'admin.queries.builder.binding-source-options' => 'Overzicht',
            'admin.run.queries.show' => 'Run',
            'admin.run.queries.data' => 'Run',
            'admin.run.queries.binding-source-options' => 'Run',
        ];
    }
};
